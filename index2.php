...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    <a href="home2.php" class="nav-item nav-link ">Home</a>
                    <a href="gallery2.php" class="nav-item nav-link active">Gallary</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="home2.php #courses" class="dropdown-item">courses</a>
                            <a href="home2.php #events" class="dropdown-item">events and Exhibitions</a>
                            <a href="home2.php #challenges" class="dropdown-item">Competitions</a>
                        </div>
                    </div>
    ...
    <?php if ($user['role'] === 'artist') : ?>
        ...
        <ul class="main-menu">
            <li class="menu-itemA" data-action="notifications">
                <i class="fas fa-bell"></i>
                <span>Notifications</span>
                <span class="badge">3</span>
            </li>
            <li class="menu-itemA" data-action="messages">
                <i class="fas fa-envelope"></i>
                <span>Messages</span>
                <span class="badge">2</span>
            </li>
            <li class="menu-itemA" data-action="requests">
                <i class="fas fa-handshake"></i>
                <span>Requests</span>
                <span class="badge">1</span>
            </li>
            <li class="divider"></li>
            <li class="menu-itemA" data-action="edit-profile">
                <a href="ArtistProfilepage2.php">
                <i class="fas fa-user-edit"></i>
                <span>Edit Profile</span>
                </a>
            </li>
            <li class="menu-itemA" data-action="community">
                <i class="fas fa-users"></i>
                <span>Community</span>
            </li>
            <li class="menu-itemA" data-action="settings">
                <i class="fas fa-cog"></i>
                <span>Settings</span>
            </li>
            <li class="menu-itemA" data-action="favorites">
                <i class="fas fa-heart"></i>
                <span>Favorites</span>
            </li>
            <li class="divider"></li>
            <li class="menu-itemE logout" data-action="logout">
...
<?php if ($user['role'] === 'enthusiast') : ?>
    <ul class="main-menu">
            <li class="menu-itemE" data-action="notifications">
                <i class="fas fa-bell"></i>
                <span>Notifications</span>
                <span class="badge">3</span>
            </li>
            <li class="menu-itemE" data-action="messages">
                <i class="fas fa-envelope"></i>
                <span>Messages</span>
                <span class="badge">2</span>
            </li>
            <li class="divider"></li>
            <li class="menu-itemE" data-action="edit-profile">
            ...
            <li class="menu-itemE" data-action="community">
                <i class="fas fa-users"></i>
                <span>Community</span>
            </li>

            <li class="menu-itemE" data-action="settings">
                <i class="fas fa-cog"></i>
                <span>Settings</span>
            </li>

            <li class="menu-itemE" data-action="favorites">
                <i class="fas fa-heart"></i>
                <span>Favorites</span>
            </li>
            <li class="divider"></li>
